...
<div class="row" style="width: 1210px;margin: 0 auto;">
    ...
    <div align="center">
        <form action="payzfb.jsp" method="post">
            <input type="submit" id="home" value="支付宝支付">
        </form>
        <form action="paywx.jsp" method="post">
            <input type="submit" id="home" value="微信支付">
        </form>
        <form action="payQQ.jsp" method="post">
            <input type="submit" id="home" value="QQ支付">
        </form>
    </div>
</div>
</body></html>